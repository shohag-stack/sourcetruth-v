...
export const OS_ICON: Record<string, ReactNode> = {
  mac: <SiApple className="h-3.5 w-3.5" />,
  windows: <FaWindows className="h-3.5 w-3.5 text-[#00A4EF]" />,
  ios: <SiApple className="h-3.5 w-3.5" />,
  android: <SiAndroid className="h-3.5 w-3.5 text-[#3DDC84]" />,
}
